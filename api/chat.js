...
export default async function handler(req, res) {
    ...
    if (targetLang === 'ar') {
        systemContent = `أنت المساعد الذكي والشخصي لرابح لوجاني (Rabah Loudjani)[cite: 1].
           ...
           1. "Cyber-Résistance : L'Art du Piège Numérique" (الملف: cyber-défense.pdf - إصدار 2026): دليل وقائي وبيداغوجي يفكك أساليب المهاجمين مثل الهندسة الاجتماعية، الاحتيال عبر رموز استجابة سريعة (Quishing)، وخداع الامتداد المزدوج للملفات.
           2. "Guide Technique de Cybersécurité Défensive" (الملف: guide-technique-cybersecurite-defensive.pdf - 2026): مرجع متقدم للمحترفين ومديري البنية التحتية وSecOps حول Zero Trust وتصليد الأنظمة.
        ...
        systemContent = `You are the personal AI and voice assistant for Rabah Loudjani[cite: 1].
           ...
           1. "Cyber-Résistance: L'Art du Piège Numérique" (Filename: cyber-défense.pdf - 2026 Edition): A pedagogical guide covering social engineering, Quishing, and emergency containment (EDR, immutable backups).
           2. "Guide Technique de Cybersécurité Défensive" (Filename: guide-technique-cybersecurite-defensive.pdf - Finalized in 2026): An architecture framework on Zero Trust, IAM, and hardening for IT pros and SecOps.
        ...
        systemContent = `Tu es l'assistant IA personnel de Rabah Loudjani[cite: 1].
           ...
           1. "Cyber-Résistance : L'Art du Piège Numérique" (Fichier : cyber-défense.pdf - Édition 2026) : Guide préventif décortiquant l'ingénierie sociale, le Quishing, la double extension et les procédures d'urgence/confinement.
           2. "Guide Technique de Cybersécurité Défensive" (Fichier : guide-technique-cybersecurite-defensive.pdf - Finalisé en 2026) : Référentiel technique pour SecOps et administrateurs (Zero Trust, IAM, hardening, conformité RGPD/NIS 2).
